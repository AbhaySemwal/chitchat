...
function Register(){
    return(
        ...
        <div class="w-full max-w-sm">
            ...
            <img src={Avt} className="w-6 h-6 cursor-pointer"></img>
            ...
            <p className="text-xs font-medium text-center pt-4">Already have an account?<a className="text-blue-600 underline cursor-pointer">Login</a></p>
        </form>
